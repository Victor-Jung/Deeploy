...
typedef struct {
	...
	signed char * __restrict__ Filter;      /**< Pointer to convolution coefficients. (Nx x Ny) coeffs in Q15 */
	signed char * __restrict__ Bias;	/**< Pointer to bias tile, used when convolution is depth wise */
	signed char * __restrict__ Scale;       /**< Pointer to reduction Scale mantissas */
	signed char * __restrict__ ScaleN;	/**< Pointer to reduction Scale exponents */
	signed char * __restrict__ Infos;	/**< Pointer to reduction Scale exponents */
        void * Extra;                           /**< Extra activation arguments */
...
typedef struct {
        ...
        unsigned short int Fx;                       /**< Filter width */
        unsigned short int Fy;                       /**< Filter height */
...
typedef struct {
	signed char * __restrict__ InOut;   	/**< Pointer to input tile  */
	signed char * __restrict__ Mean;  	/**< Pointer to output tile */
	signed char * __restrict__ Weights;  	/**< Pointer to output tile */
	signed char * __restrict__ Out;  	/**< Pointer to output tile */
	signed char * __restrict__ Infos;  	/**< Pointer to output tile */
	unsigned short int OutFeatures;		/**< Is This the last tile */
	unsigned int InnerDim;	/**< Number of features, used only for channel parallel kernels */
} KerLayerNorm_SQ8_T;
...
typedef struct {
	...
	unsigned short *__restrict__ SigmoidLUT;/**< Address of SigmoidLUT in L1 */
} KerRNN_SQ8_T;
...
typedef struct {
	...
	int TileOffset;				/**< Buffer Offset related to the current Tile index */
	int NBatch;				/**< Number of parallel input sequence/state to process */
	unsigned short *__restrict__ SigmoidLUT;/**< Address of SigmoidLUT in L1 */
} KerLSTM_SQ8_T;
...
#define AT_INF_ATTN_NORM_FP_SCALE_IN	0
#define AT_INF_ATTN_NORM_FP_SCALE_IN_LEN	2
#define AT_INF_ATTN_NORM_FP_SCALE_OUT	(AT_INF_ATTN_NORM_FP_SCALE_IN + AT_INF_ATTN_NORM_FP_SCALE_IN_LEN)
#define AT_INF_ATTN_NORM_FP_SCALE_OUT_LEN	2
#define AT_INF_ATTN_NORM_FP_ZP_IN	(AT_INF_ATTN_NORM_FP_SCALE_OUT + AT_INF_ATTN_NORM_FP_SCALE_OUT_LEN)
#define AT_INF_ATTN_NORM_FP_ZP_IN_LEN	2
#define AT_INF_ATTN_NORM_FP_ZP_OUT	(AT_INF_ATTN_NORM_FP_ZP_IN + AT_INF_ATTN_NORM_FP_ZP_IN_LEN)
#define AT_INF_ATTN_NORM_FP_ZP_OUT_LEN	2
#define AT_INF_ATTN_NORM_FP_WFAC	(AT_INF_ATTN_NORM_FP_ZP_OUT + AT_INF_ATTN_NORM_FP_ZP_OUT_LEN)
#define AT_INF_ATTN_NORM_FP_WFAC_LEN	2
#define AT_INF_ATTN_NORM_FP_HFAC	(AT_INF_ATTN_NORM_FP_WFAC + AT_INF_ATTN_NORM_FP_WFAC_LEN)
#define AT_INF_ATTN_NORM_FP_HFAC_LEN	2
#define AT_INF_ATTN_NORM_FP_LEN		(AT_INF_ATTN_NORM_FP_HFAC + AT_INF_ATTN_NORM_FP_HFAC_LEN)

#define AT_INF_ATTN_NORM_SCALE_IN	0
#define AT_INF_ATTN_NORM_SCALE_IN_LEN	1
#define AT_INF_ATTN_NORM_NORM_IN	(AT_INF_ATTN_NORM_SCALE_IN + AT_INF_ATTN_NORM_SCALE_IN_LEN)
#define AT_INF_ATTN_NORM_NORM_IN_LEN	1
#define AT_INF_ATTN_NORM_SCALE_OUT	(AT_INF_ATTN_NORM_NORM_IN + AT_INF_ATTN_NORM_NORM_IN_LEN)
#define AT_INF_ATTN_NORM_SCALE_OUT_LEN	1
#define AT_INF_ATTN_NORM_NORM_OUT	(AT_INF_ATTN_NORM_SCALE_OUT + AT_INF_ATTN_NORM_SCALE_OUT_LEN)
#define AT_INF_ATTN_NORM_NORM_OUT_LEN	1
#define AT_INF_ATTN_NORM_HBITS		(AT_INF_ATTN_NORM_NORM_OUT + AT_INF_ATTN_NORM_NORM_OUT_LEN)
#define AT_INF_ATTN_NORM_HBITS_LEN	1
#define AT_INF_ATTN_NORM_WBITS		(AT_INF_ATTN_NORM_HBITS + AT_INF_ATTN_NORM_HBITS_LEN)
#define AT_INF_ATTN_NORM_WBITS_LEN	1
#define AT_INF_ATTN_NORM_N1		(AT_INF_ATTN_NORM_WBITS + AT_INF_ATTN_NORM_WBITS_LEN)
#define AT_INF_ATTN_NORM_N1_LEN		2
#define AT_INF_ATTN_NORM_1		(AT_INF_ATTN_NORM_N1 + AT_INF_ATTN_NORM_N1_LEN)
#define AT_INF_ATTN_NORM_1_LEN		2
#define AT_INF_ATTN_NORM_ZP_IN 		(AT_INF_ATTN_NORM_1 + AT_INF_ATTN_NORM_1_LEN)
#define AT_INF_ATTN_NORM_ZP_IN_LEN 	2
#define AT_INF_ATTN_NORM_ZP_OUT 	(AT_INF_ATTN_NORM_ZP_IN + AT_INF_ATTN_NORM_ZP_IN_LEN)
#define AT_INF_ATTN_NORM_ZP_OUT_LEN 	2
#define AT_INF_ATTN_NORM_LEN		(AT_INF_ATTN_NORM_ZP_OUT + AT_INF_ATTN_NORM_ZP_OUT_LEN)

typedef struct {
	void *__restrict__ InOut;		/**< Pointer to In/Out tensor   */
	int * __restrict__ RowBuf;		/**< Pointer to buffer for row sums   */
	int * __restrict__ ColBuf;		/**< Pointer to buffers (* ncore) for column partially normed elements   */
...
extern void KerParConvDW8x1Stride1x1B32_SQ8(KerConv_SQ8_T *Arg);
extern void KerParConvDW8x1Stride1x1B32_HWC_NoPad_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDW8x1Stride1x1B32_Leaky_HWC_NoPad_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDW8x1Stride1x1B32_HWC_NoPad_USQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDW8x1Stride1x1B32_Leaky_HWC_NoPad_USQ8(KerConvRedAct_SQ8_T *Arg);
...
extern void KerParConvDWNxMStrideSxSyB32_SQ16(KerConv_SQ8_T *Arg);

/* 32 Bits Bias, Reduction+Activation Features in parallel */
extern void KerParConvDWRedAct1x1Stride1B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct1x1Stride1B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct1x1Stride1B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct1x1Stride1B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerParConvDWRedAct1x1Stride2B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct1x1Stride2B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct1x1Stride2B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct1x1Stride2B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerParConvDWRedAct1x1StrideSB32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct1x1StrideSB32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct1x1StrideSB32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct1x1StrideSB32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerParConvDWRedAct3x1Stride1x1B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct3x1Stride1x1B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct3x1Stride1x1B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct3x1Stride1x1B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerParConvDWRedAct3x1Stride2x1B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct3x1Stride2x1B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct3x1Stride2x1B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct3x1Stride2x1B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerParConvDWRedAct1x3Stride1x1B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct1x3Stride1x1B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct1x3Stride1x1B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct1x3Stride1x1B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerParConvDWRedAct1x3Stride1x2B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct1x3Stride1x2B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct1x3Stride1x2B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct1x3Stride1x2B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerParConvDWRedAct3x3Stride1B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct3x3Stride1B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct3x3Stride1B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct3x3Stride1B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerParConvDWRedAct3x3Stride2B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct3x3Stride2B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct3x3Stride2B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct3x3Stride2B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerParConvDWRedAct3x3StrideSB32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct3x3StrideSB32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct3x3StrideSB32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct3x3StrideSB32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerParConvDWRedAct5x1Stride1x1B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct5x1Stride1x1B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct5x1Stride1x1B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct5x1Stride1x1B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerParConvDWRedAct5x1Stride2x1B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct5x1Stride2x1B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct5x1Stride2x1B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct5x1Stride2x1B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerParConvDWRedAct1x5Stride1x1B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct1x5Stride1x1B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct1x5Stride1x1B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct1x5Stride1x1B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerParConvDWRedAct1x5Stride1x2B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct1x5Stride1x2B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct1x5Stride1x2B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct1x5Stride1x2B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerParConvDWRedAct5x5Stride1B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct5x5Stride1B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct5x5Stride1B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct5x5Stride1B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerParConvDWRedAct5x5Stride2B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct5x5Stride2B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct5x5Stride2B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct5x5Stride2B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerParConvDWRedAct5x5StrideSB32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct5x5StrideSB32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct5x5StrideSB32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct5x5StrideSB32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerParConvDWRedAct7x7StrideSB32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct7x7StrideSB32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct7x7StrideSB32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedAct7x7StrideSB32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerParConvDWRedActNxNStrideSB32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedActNxNStrideSB32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedActNxNStrideSB32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedActNxNStrideSB32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerParConvDWRedActNxMStrideSxSyB32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedActNxMStrideSxSyB32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedActNxMStrideSxSyB32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedActNxMStrideSxSyB32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerParConvDWRedActNxMStrideSxSyB32_SQ16(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedActNxMStrideSxSyB32_ReLU_SQ16(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedActNxMStrideSxSyB32_ReLUN_SQ16(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedActNxMStrideSxSyB32_ReLUM_SQ16(KerConvRedAct_SQ8_T *Arg);

extern void KerParConvDWRedActNxMDxDyStrideSxSyB32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedActNxMDxDyStrideSxSyB32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedActNxMDxDyStrideSxSyB32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedActNxMDxDyStrideSxSyB32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerParConvDWRedActNxMDxDyStrideSxSyB32_SQ16(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedActNxMDxDyStrideSxSyB32_ReLU_SQ16(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedActNxMDxDyStrideSxSyB32_ReLUM_SQ16(KerConvRedAct_SQ8_T *Arg);
extern void KerParConvDWRedActNxMDxDyStrideSxSyB32_ReLUN_SQ16(KerConvRedAct_SQ8_T *Arg);
...
/* 32 Bits Bias, Conv+Reduction+Activation One Feature in parallel */
extern void KerConvDWRedAct1x1Stride1B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct1x1Stride1B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct1x1Stride1B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct1x1Stride1B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerConvDWRedAct1x1Stride2B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct1x1Stride2B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct1x1Stride2B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct1x1Stride2B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerConvDWRedAct1x1StrideSB32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct1x1StrideSB32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct1x1StrideSB32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct1x1StrideSB32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerConvDWRedAct3x1Stride1x1B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct3x1Stride1x1B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct3x1Stride1x1B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct3x1Stride1x1B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerConvDWRedAct3x1Stride2x1B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct3x1Stride2x1B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct3x1Stride2x1B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct3x1Stride2x1B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerConvDWRedAct1x3Stride1x1B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct1x3Stride1x1B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct1x3Stride1x1B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct1x3Stride1x1B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerConvDWRedAct1x3Stride1x2B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct1x3Stride1x2B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct1x3Stride1x2B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct1x3Stride1x2B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerConvDWRedAct3x3Stride1B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct3x3Stride1B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct3x3Stride1B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct3x3Stride1B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerConvDWRedAct3x3Stride2B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct3x3Stride2B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct3x3Stride2B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct3x3Stride2B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerConvDWRedAct3x3StrideSB32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct3x3StrideSB32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct3x3StrideSB32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct3x3StrideSB32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerConvDWRedAct5x1Stride1x1B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct5x1Stride1x1B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct5x1Stride1x1B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct5x1Stride1x1B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerConvDWRedAct5x1Stride2x1B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct5x1Stride2x1B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct5x1Stride2x1B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct5x1Stride2x1B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerConvDWRedAct1x5Stride1x1B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct1x5Stride1x1B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct1x5Stride1x1B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct1x5Stride1x1B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerConvDWRedAct1x5Stride1x2B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct1x5Stride1x2B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct1x5Stride1x2B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct1x5Stride1x2B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerConvDWRedAct5x5Stride1B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct5x5Stride1B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct5x5Stride1B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct5x5Stride1B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerConvDWRedAct5x5Stride2B32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct5x5Stride2B32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct5x5Stride2B32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct5x5Stride2B32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerConvDWRedAct5x5StrideSB32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct5x5StrideSB32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct5x5StrideSB32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct5x5StrideSB32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerConvDWRedAct7x7StrideSB32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct7x7StrideSB32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct7x7StrideSB32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedAct7x7StrideSB32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerConvDWRedActNxNStrideSB32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedActNxNStrideSB32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedActNxNStrideSB32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedActNxNStrideSB32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerConvDWRedActNxMStrideSxSyB32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedActNxMStrideSxSyB32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedActNxMStrideSxSyB32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedActNxMStrideSxSyB32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);

extern void KerConvDWRedActNxMDxDyStrideSxSyB32_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedActNxMDxDyStrideSxSyB32_ReLU_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedActNxMDxDyStrideSxSyB32_ReLUM_SQ8(KerConvRedAct_SQ8_T *Arg);
extern void KerConvDWRedActNxMDxDyStrideSxSyB32_ReLUN_SQ8(KerConvRedAct_SQ8_T *Arg);
...
extern short int ERF_LUT_int16[];

int ErfTable(int x, short int * table);
...
#define __SigmoidTableInline(__x, __table, __unsigned) ({ \
	int __result; \
	int __abs_x = (Abs(__x) * 3) >> 9; \
	if (__abs_x > 255) __result = 0xFFFF; \
	else 		   __result = __table[__abs_x]; \
	__result = (__x > 0)?__result:((1<<16) - __result); \
        __result >> (__unsigned?0:1);})

#define SigmoidTableInline(x, table)         __SigmoidTableInline(x, table, 0)
#define SigmoidTableUnsignedInline(x, table) __SigmoidTableInline(x, table, 1)

#define TanhTableInline(__x, __table) ({ \
	int __result; \
	int __abs_x = (Abs(__x) * 3) >> 8; \
	if (__abs_x > 255) __result = 0xFFFF; \
	else       	 __result = __table[__abs_x]; \
        __result = (__x > 0)?(__result - (1 << 15)):(-__result + (1 << 15)); \
	__result;})

#define Erf(__x) ErfTable((__x), ERF_LUT_int16)
...
#define ACT_SWITCH_NOASCALE(__acc, __act_type, __a0, __b0, __c0, __in_n_bits, __in_unsigned, __out_n_bits, __out_unsigned, Extra) \
do { \
	switch (__act_type) { \
		case ACT_NONE: \
			break; \
		case ACT_RELU: \
			...
			break; \
		case ACT_RELUN: \
			__acc = AT_CLIP_POS(__acc, __a0); \
			break; \
		case ACT_RELUM: \
			__acc = Max(__a0, __acc); \
			break; \
		case ACT_RELUMN: \
			__acc = Max(__a0, Min(__acc, __b0)); \
			break; \
		case ACT_HSIGMOID: \
			__acc = AT_CLIP_POS(__acc + __b0, __a0) + __c0; \
			break; \
		case ACT_HSWISH: \
			__acc = AT_CLIP_POS(__acc + __b0, __a0) * __acc + __c0; \
			break; \
		case ACT_LEAKYRELU: \
			{ \
				int Neg0 = gap_bitextractu(__acc, 1, 31), Pos0 = !Neg0; \
				int Acc0N = AT_NORM(__acc * __a0, 7); \
				__acc = (Neg0*Acc0N+Pos0*__acc) + __b0; \
			} \
			break; \
		case ACT_SIGMOID: \
			{ \
				int in_zero_point = __in_unsigned?((__in_n_bits==8)?(1<<7):(1<<15)):0; \
				int Acc0N = ( ((int) __acc) - in_zero_point) << ((__in_n_bits==8)?8:0); \
				__acc = SigmoidTable(Acc0N, (unsigned short *)Extra) + __a0; \
			} \
			break; \
		case ACT_SIGMOID_FAST: \
			{ \
				int in_zero_point = __in_unsigned?((__in_n_bits==8)?(1<<7):(1<<15)):0; \
				int Acc0N = ((int) __acc) - in_zero_point; \
                                int abs_x = AT_CLIP_POS(Abs(Acc0N), ((__out_n_bits==8)?(1<<7):(1<<8)) - 1); \
                                int result; \
                                if (__out_n_bits==8) \
				result = ((signed char *)Extra)[abs_x]; \
                                else \
				result = ((signed short *)Extra)[abs_x]; \
				__acc = ((Acc0N<0)?((1 << ((__out_n_bits==8)?7:15)) - 1 - result):result) + __a0; \
			} \
			break; \
		case ACT_TANH: \
			{ \
				int in_zero_point = __in_unsigned?((__in_n_bits==8)?(1<<7):(1<<15)):0; \
				int Acc0N = ( ((int) __acc) - in_zero_point) << ((__in_n_bits==8)?8:0); \
				if (!__out_unsigned) __acc = TanhTable(Acc0N, (unsigned short *)Extra); \
				else 		     __acc = TanhTable(Acc0N, (unsigned short *)Extra) + __a0; \
			} \
			break; \
		case ACT_TANH_FAST: \
			{ \
				...
				result = ((signed short *)Extra)[abs_x]; \
				__acc = ((Acc0N<0)?(-result):result) + __a0; \
			} \
			break; \
		case ACT_HTANH: \
			break; \
...
#define ACT_SWITCH(__acc, __act_type, __act_scale, __act_scalen, __a0, __b0, __c0, __in_n_bits, __in_unsigned, __out_n_bits, __out_unsigned, Extra) \
do { \
	switch (__act_type) { \
		case ACT_NONE: \
			break; \
		...
		case ACT_SIGMOID: \
			{ \
				int in_zero_point = __in_unsigned?((__in_n_bits==8)?(1<<7):(1<<15)):0; \
				int Acc0N = ( ((int) __acc) - in_zero_point) << ((__in_n_bits==8)?8:0); \
				__acc = AT_SCALE(SigmoidTable(Acc0N, (unsigned short *)Extra),  __act_scale, __act_scalen) + __a0; \
			} \
			break; \
		case ACT_SIGMOID_FAST: \
			{ \
				...
				result = ((signed short *)Extra)[abs_x]; \
				__acc = AT_SCALE(((Acc0N<0)?((1 << ((__out_n_bits==8)?7:15)) - 1 - result):result), __act_scale, __act_scalen) + __a0; \
			} \
			break; \
		case ACT_TANH: \
			{ \
				int in_zero_point = __in_unsigned?((__in_n_bits==8)?(1<<7):(1<<15)):0; \
				int Acc0N = ( ((int) __acc) - in_zero_point) << ((__in_n_bits==8)?8:0); \
				if (!__out_unsigned) __acc = AT_SCALE(TanhTable(Acc0N, (unsigned short *)Extra), __act_scale, __act_scalen); \
				else 		     __acc = AT_SCALE(TanhTable(Acc0N, (unsigned short *)Extra), __act_scale, __act_scalen) + __a0; \
			} \
			break; \
		case ACT_TANH_FAST: \
			{ \
				...
				result = ((signed short *)Extra)[abs_x]; \
				__acc = AT_SCALE((Acc0N<0)?(-result):result, __act_scale, __act_scalen) + __a0; \
			} \
			break; \
		case ACT_HTANH: \
			break; \
...
extern void KerParReduct_CC_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_ReLU_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_ReLUN_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_ReLUM_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_ReLUMN_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_HSigmoid_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_HSwish_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_LeakyReLU_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_Sigmoid_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_Tanh_USQ8(KerConvLinReduct_SQ8_T *Arg);

extern void KerParReduct_CC_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_ReLU_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_ReLUN_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_ReLUM_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_ReLUMN_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_HSigmoid_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_HSwish_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_LeakyReLU_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_Sigmoid_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_Tanh_SQ16(KerConvLinReduct_SQ8_T *Arg);

extern void KerParReduct_CC_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_ReLU_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_ReLUN_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_ReLUM_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_ReLUMN_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_HSigmoid_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_HSwish_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_LeakyReLU_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_Sigmoid_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_Tanh_USQ16(KerConvLinReduct_SQ8_T *Arg);

/*
 * Scaling applied CHW order then activations written to output in HWC order (Transposed on the fly)
 * used for DepthWise in HWC models (evaluated in CHW but transposition before writing out)
*/
...
extern void KerParReduct_CC_CHW2HWC_ReLUM_SQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_ReLUMN_SQ8(KerConvLinReduct_SQ8_T *Arg);
...
extern void KerParReduct_CC_CHW2HWC_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_ReLU_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_ReLUN_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_ReLUM_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_ReLUMN_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_HSigmoid_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_HSwish_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_LeakyReLU_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_Sigmoid_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_Tanh_USQ8(KerConvLinReduct_SQ8_T *Arg);

extern void KerParReduct_CC_CHW2HWC_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_ReLU_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_ReLUN_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_ReLUM_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_ReLUMN_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_HSigmoid_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_HSwish_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_LeakyReLU_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_Sigmoid_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_Tanh_SQ16(KerConvLinReduct_SQ8_T *Arg);

extern void KerParReduct_CC_CHW2HWC_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_ReLU_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_ReLUN_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_ReLUM_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_ReLUMN_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_HSigmoid_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_HSwish_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_LeakyReLU_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_Sigmoid_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerParReduct_CC_CHW2HWC_Tanh_USQ16(KerConvLinReduct_SQ8_T *Arg);
/*
 * Input Scaling and reduction to 8b then channel centric activation, Out location = In location. Features are evaluated in parallel
*/
...
extern void KerReduct_CC_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_ReLU_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_ReLUN_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_ReLUM_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_ReLUMN_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_HSigmoid_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_HSwish_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_LeakyReLU_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_Sigmoid_USQ8(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_Tanh_USQ8(KerConvLinReduct_SQ8_T *Arg);

extern void KerReduct_CC_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_ReLU_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_ReLUN_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_ReLUM_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_ReLUMN_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_HSigmoid_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_HSwish_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_LeakyReLU_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_Sigmoid_SQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_Tanh_SQ16(KerConvLinReduct_SQ8_T *Arg);

extern void KerReduct_CC_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_ReLU_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_ReLUN_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_ReLUM_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_ReLUMN_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_HSigmoid_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_HSwish_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_LeakyReLU_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_Sigmoid_USQ16(KerConvLinReduct_SQ8_T *Arg);
extern void KerReduct_CC_Tanh_USQ16(KerConvLinReduct_SQ8_T *Arg);
...
extern void Ker_ActNone_SUSQ8(KerActivation_SQ8_T *Arg);
extern void Ker_ReLU_SUSQ8(KerActivation_SQ8_T *Arg);
extern void Ker_ReLUN_SUSQ8(KerActivation_SQ8_T *Arg);
extern void Ker_ReLUM_SUSQ8(KerActivation_SQ8_T *Arg);
extern void Ker_ReLUMN_SUSQ8(KerActivation_SQ8_T *Arg);
extern void Ker_HSigmoid_SUSQ8(KerActivation_SQ8_T *Arg);
extern void Ker_HSwish_SUSQ8(KerActivation_SQ8_T *Arg);
extern void Ker_LeakyReLU_SUSQ8(KerActivation_SQ8_T *Arg);
extern void Ker_Sigmoid_SUSQ8(KerActivation_SQ8_T *Arg);
extern void Ker_Tanh_SUSQ8(KerActivation_SQ8_T *Arg);

extern void Ker_ActNone_USQ8(KerActivation_SQ8_T *Arg);
extern void Ker_ReLU_USQ8(KerActivation_SQ8_T *Arg);
extern void Ker_ReLUN_USQ8(KerActivation_SQ8_T *Arg);
extern void Ker_ReLUM_USQ8(KerActivation_SQ8_T *Arg);
extern void Ker_ReLUMN_USQ8(KerActivation_SQ8_T *Arg);
extern void Ker_HSigmoid_USQ8(KerActivation_SQ8_T *Arg);
extern void Ker_HSwish_USQ8(KerActivation_SQ8_T *Arg);
extern void Ker_LeakyReLU_USQ8(KerActivation_SQ8_T *Arg);
extern void Ker_Sigmoid_USQ8(KerActivation_SQ8_T *Arg);
extern void Ker_Tanh_USQ8(KerActivation_SQ8_T *Arg);

extern void Ker_ActNone_SQ16(KerActivation_SQ8_T *Arg);
extern void Ker_ReLU_SQ16(KerActivation_SQ8_T *Arg);
extern void Ker_ReLUN_SQ16(KerActivation_SQ8_T *Arg);
extern void Ker_ReLUM_SQ16(KerActivation_SQ8_T *Arg);
extern void Ker_ReLUMN_SQ16(KerActivation_SQ8_T *Arg);
extern void Ker_HSigmoid_SQ16(KerActivation_SQ8_T *Arg);
extern void Ker_HSwish_SQ16(KerActivation_SQ8_T *Arg);
extern void Ker_LeakyReLU_SQ16(KerActivation_SQ8_T *Arg);
extern void Ker_Sigmoid_SQ16(KerActivation_SQ8_T *Arg);
extern void Ker_Tanh_SQ16(KerActivation_SQ8_T *Arg);

extern void Ker_ActNone_USQ16(KerActivation_SQ8_T *Arg);
extern void Ker_ReLU_USQ16(KerActivation_SQ8_T *Arg);
extern void Ker_ReLUN_USQ16(KerActivation_SQ8_T *Arg);
extern void Ker_ReLUM_USQ16(KerActivation_SQ8_T *Arg);
extern void Ker_ReLUMN_USQ16(KerActivation_SQ8_T *Arg);
extern void Ker_HSigmoid_USQ16(KerActivation_SQ8_T *Arg);
extern void Ker_HSwish_USQ16(KerActivation_SQ8_T *Arg);
extern void Ker_LeakyReLU_USQ16(KerActivation_SQ8_T *Arg);
extern void Ker_Sigmoid_USQ16(KerActivation_SQ8_T *Arg);
extern void Ker_Tanh_USQ16(KerActivation_SQ8_T *Arg);
...
extern void KerSubPowInplace_SQ8(KerLayerNorm_SQ8_T *Arg);
extern void KerAddAndRSqrt_SQ8(KerLayerNorm_SQ8_T *Arg);
...
extern void KerMatAddSameScale_SQ8(KerMat3_SQ8_T *Arg);
extern void KerMatAddSameScale_ReLU_SQ8(KerMat3_SQ8_T *Arg);
extern void KerMatAddSameScale_ReLUN_SQ8(KerMat3_SQ8_T *Arg);
extern void KerMatAddSameScale_HSigmoid_SQ8(KerMat3_SQ8_T *Arg);
extern void KerMatAddSameScale_HSwish_SQ8(KerMat3_SQ8_T *Arg);
extern void KerMatAddSameScale_LeakyReLU_SQ8(KerMat3_SQ8_T *Arg);

extern void KerMatAddSameScale_USQ8(KerMat3_SQ8_T *Arg);
extern void KerMatAddSameScale_ReLU_USQ8(KerMat3_SQ8_T *Arg);
extern void KerMatAddSameScale_ReLUN_USQ8(KerMat3_SQ8_T *Arg);
extern void KerMatAddSameScale_ReLUM_USQ8(KerMat3_SQ8_T *Arg);
extern void KerMatAddSameScale_ReLUMN_USQ8(KerMat3_SQ8_T *Arg);
...
extern void KerParH_MM_Conv2D_HWC_SQ8(Ker_MM_Conv_SQ8_T *Arg);
extern void KerParH_MM_Conv2D_ReLU_HWC_SQ8(Ker_MM_Conv_SQ8_T *Arg);
extern void KerParH_MM_Conv2D_ReLUN_HWC_SQ8(Ker_MM_Conv_SQ8_T *Arg);
extern void KerParH_MM_Conv2D_ReLUM_HWC_SQ8(Ker_MM_Conv_SQ8_T *Arg);
extern void KerParH_MM_Conv2D_ReLUMN_HWC_SQ8(Ker_MM_Conv_SQ8_T *Arg);
extern void KerParH_MM_Conv2D_LeakyReLU_HWC_SQ8(Ker_MM_Conv_SQ8_T *Arg);
extern void KerParH_MM_Conv2D_HSwish_HWC_SQ8(Ker_MM_Conv_SQ8_T *Arg);
extern void KerParH_MM_Conv2D_HSigmoid_HWC_SQ8(Ker_MM_Conv_SQ8_T *Arg);
extern void KerParH_MM_Conv2D_Sigmoid_HWC_SQ8(Ker_MM_Conv_SQ8_T *Arg);
extern void KerParH_MM_Conv2D_Tanh_HWC_SQ8(Ker_MM_Conv_SQ8_T *Arg);
...
extern void Batched_LSTM_ParKerB32_SQ8(KerLSTM_SQ8_T *Arg);
...
extern void KerAttnNormRowSum_USQ16(KerAttnNorm_SQ8_T *Arg);
extern void KerAttnNormColSum_USQ16(KerAttnNorm_SQ8_T *Arg);
extern void KerAttnNormRowSum_SQ16(KerAttnNorm_SQ8_T *Arg);
extern void KerAttnNormColSum_SQ16(KerAttnNorm_SQ8_T *Arg);
extern void KerAttnNormRowAndColSum_USQ16_Float16_InL1(KerAttnNorm_SQ8_T *Arg);
extern void KerAttnNormRowAndColSum_SQ16_Float16_InL1(KerAttnNorm_SQ8_T *Arg);

extern void KerAttnNormColSum_USQ16_Float16_InL1(KerAttnNorm_SQ8_T *Arg);
extern void KerAttnNormColSum_SQ16_Float16_InL1(KerAttnNorm_SQ8_T *Arg);
#endif
