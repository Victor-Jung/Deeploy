...
if __name__ == '__main__':
    ...
    parser.add_argument('--l1', metavar = 'l1', dest = 'l1', type = int, default = 64000, help = 'Set L1 size in bytes. \n')
    parser.add_argument('--l2', metavar = 'l2', dest = 'l2', type = int, default = 1024000, help = 'Set L2 size in bytes.\n')
